...
const page = () => {
  return (
    <div className="bg-white dark:bg-secondary">
      ...
      <MAConsulting services={services} heading={"Our Merger and Acquisition Consultant Services"} />
      <TabView  tabs={tabs} heading={"Merger and Acquisition Advisory Process"}/>
