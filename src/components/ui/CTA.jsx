...
export default function CTA({ title, description, subtext, buttonText, buttonLink, imageSrc ,other}) {
    return (
      <div className="flex flex-col md:flex-row items-center justify-between bg-primary dark:bg-darkLvl2 text-white rounded-2xl shadow-lg mx-auto m-5">
